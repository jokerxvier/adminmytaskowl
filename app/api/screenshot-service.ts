...
export async function searchScreenshotOrg(query: string) {
  ...
  const res = await fetch(
    `${GlobalSettings.BASE_URL}super-admin/searchOrgScreenshot`,
    {
      method: "POST",
      headers: {
...
export async function selectOrgSS(organizationID: number) {
  ...
  const res = await fetch(
    `${GlobalSettings.BASE_URL}super-admin/selectedOrgSS`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function getScreenshots(
  ...
  const res = await fetch(
    `${GlobalSettings.BASE_URL}super-admin/getUserScreenshotsAdmin`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function toggleDisableScreenshot(screenshot_id: number) {
  ...
  const res = await fetch(
    `${GlobalSettings.BASE_URL}super-admin/toggleDisableScreenshot`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function getAvailableDates(
  ...
  const res = await fetch(
    `${GlobalSettings.BASE_URL}super-admin/screenshotAvailableDates`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
