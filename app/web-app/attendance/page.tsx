...
export default function AttendancePage() {
  ...
  return (
    <div className=" p-4 space-y-4">
      ...
      />
      <Button disabled={query.length < 2 || loading} onClick={handleSearch}>
        ...
        <ul className="">
          {results.map((org) => (
            <li key={org.organization_id} className="mt-4">
              ...
              >
                <strong>ID:</strong> {org.organization_id},{" "}
        ...
        <div className="inset-0 z-50  flex items-center justify-center ">
          <div className="rounded-lg shadow-lg p-6 w-full max-w-md relative flex flex-col items-center justify-center border rounded-md">
            ...
            <div className="mt-4 items-center justify-center ">
              <span className="text-md ">{selectedOrg.name}</span>
      ...
      {attendance.length > 0 && (
        <div className="mt-4">
          <h3 className="text-lg text-center font-medium my-8">
            Attendance for {selectedDate?.toString()}
          </h3>
